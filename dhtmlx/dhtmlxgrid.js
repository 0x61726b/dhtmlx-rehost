...
if (typeof (window.dhtmlxEvent) != "undefined" && window.dhtmlxEvent.touchDelay == null) {
    window.dhtmlxEvent.touchDelay = 2000
}
if (typeof (window.dhtmlxEvent.initTouch) == "undefined") {
    window.dhtmlxEvent.initTouch = function () {
        var d;
        var e;
        var b, a;
        window.dhtmlxEvent(document.body, "touchstart", function (f) {
            e = f.touches[0].target;
            b = f.touches[0].clientX;
            a = f.touches[0].clientY;
            d = window.setTimeout(c, window.dhtmlxEvent.touchDelay)
        });
        ...
        window.dhtmlxEvent(document.body, "touchmove", function (f) {
            if (d) {
        ...
        window.dhtmlxEvent(document.body, "touchend", function (f) {
            if (d) {
                window.clearTimeout(d);
                d = e = false
            }
...
dataProcessor.prototype = {
    ...
    _sendData: function (e, f) {
        ...
        var l = this._applyPayload(b);
        if (this._tMode == "GET") {
            dhx4.ajax.query({
                url: l + ((l.indexOf("?") != -1) ? "&" : "?") + this.serialize(e, f),
                method: "GET",
...
function dhtmlXCalendarObject(f, l) {
    ...
    this.conf = {
        skin: (l || window.dhx4.skin || (typeof (dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhtmlxcalendar") || "material"),
    ...
    this.show = function (o) {
        if (!o && this._hasParent) {
            this._show();
            return
        }
        if (typeof (o) == "string") {
            var n = document.getElementById(o);
            if (n != null && typeof (n._dhtmlxcalendar_uid) != "undefined" && this.i[n._dhtmlxcalendar_uid] != null) {
                this._show(n._dhtmlxcalendar_uid);
                return
            }
        }
        if (typeof (o) == "object" && typeof (o._dhtmlxcalendar_uid) != "undefined" && this.i[o._dhtmlxcalendar_uid] == o) {
            this._show(o._dhtmlxcalendar_uid);
            return
        }
    ...
    this._show = function (r, m) {
        ...
        if (!r) {
            ...
            var q = {
                top: window.dhx4.absTop(n),
                left: window.dhx4.absLeft(n)
            };
            if (this.pos == "right") {
        ...
        for (var r = 0; r < this.contDates.childNodes.length; r++) {
            for (var a = 0; a < this.contDates.childNodes[r].childNodes.length; a++) {
                ...
                if (s._date != null && s._date.getTime() == o) {
                    m = {
                        x: window.dhx4.absLeft(s),
                        y: window.dhx4.absTop(s),
                        w: s.offsetWidth,
                        h: s.offsetHeight
                    }
                }
...
function dhtmlXCombo(f, j, c, h, e) {
    ...
    this.setSkin(l || window.dhx4.skin || (typeof (dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhxcombo") || "material");
    ...
    this._filterOpts = function (u) {
        ...
        var o = String(this.base.firstChild.value).replace(new RegExp(this._fixRE(this.conf.f_ac_text) + "$", "i"), "");
        ...
        if (this.conf.f_url != null) {
            ...
            this.conf.f_server_last = o.toLowerCase();
            var m = (o.length == 0 ? true : new RegExp((this.conf.f_mode == "start" ? "^" : "") + this._fixRE(o), "i"));
            var p = null;
            for (var v in this.t) {
                var x = false;
                if (m !== true) {
    ...
    this._doOnInputFocus = function () {
        ...
        if (g.conf.combo_focus == false) {
            ...
            if (g.conf.skin == "material" && g.base.className.match(/dhxcombo_actv/) == null) {
                g.base.className += " dhxcombo_actv"
            }
            g.callEvent("onFocus", [])
        }
    };
    this._doOnInputBlur = function () {
        ...
        g.conf.tm_confirm_blur = window.setTimeout(function () {
            if (g.conf.clear_click == false) {
                ...
                if (g.conf.skin == "material" && g.base.className.match(/dhxcombo_actv/) != null) {
                    g.base.className = g.base.className.replace(/\s*dhxcombo_actv/gi, "")
                }
                g.callEvent("onBlur", [])
            }
        }, 20)
...
function dhtmlXMenuObject(e, f) {
    var d = this;
    this.conf = {
        skin: (f || window.dhx4.skin || (typeof (dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhxmenu") || "material"),
        mode: "web",
        align: "left",
        is_touched: false,
        selected: -1,
...
dhtmlXMenuObject.prototype._updateItemImage = function (c, d) {
    ...
    if (f) {
        for (var a = 0; a < this.idPull[c].childNodes.length; a++) {
            if (g == null && (this.idPull[c].childNodes[a].className || "") == "dhtmlxMenu_TopLevel_Item_Icon" || (this.idPull[c].childNodes[a].tagName || "").toLowerCase() == "i") {
        ...
        if (!(g != null && typeof (g.className) != "undefined" && (g.className == "sub_icon" || g.tagName.toLowerCase() == "i"))) {
            g = null
        }
    }
    ...
    if (l.length > 0) {
        if (g != null) {
            if (this.conf.icons_css == true) {
                g.className = this.conf.icons_path + l
            } else {
            ...
            if (f) {
                ...
                if (this.conf.icons_css == true) {
                    ...
                    j.innerHTML = "<i class='" + this.conf.icons_path + l + "'></i>"
                } else {
                    var g = document.createElement("IMG");
...
dhtmlXMenuObject.prototype._renderToplevelItem = function (h, g) {
    ...
    if ((this.itemPull[h]["imgen"] != "") || (this.itemPull[h]["imgdis"] != "")) {
        ...
        if (d) {
            if (this.conf.icons_css == true) {
                ...
                c.className = this.conf.icons_path + d;
    ...
    a.onmouseover = function () {
        ...
        for (var m = 0; m < j.length; m++) {
            ...
            if ((f.idPull[j[m]] != null) && (j[m] != this.id)) {
                if (f.itemPull[j[m]]["cssNormal"] != null) {
                    f.idPull[j[m]].className = f.itemPull[j[m]]["cssNormal"]
                } else {
                    if (f.idPull[j[m]].className == "sub_item_selected") {
                        f.idPull[j[m]].className = "sub_item"
                    }
                    f.idPull[j[m]].className = f.idPull[j[m]].className.replace(/Selected/g, "Normal")
                }
            }
        }
        if (f.itemPull[this.id]["state"] == "enabled") {
            ...
            if (f.conf.dload) {
                if (f.itemPull[this.id].loaded == "no") {
                    ...
                    var n = this.id.replace(f.idPrefix, "");
                    f._dhxdataload.onBeforeXLS = function () {
                        var o = {
                            params: {}
                        };
                        o.params[this.conf.dload_pid] = n;
                        for (var i in this.conf.dload_params) {
                            o.params[i] = this.conf.dload_params[i]
                        }
                        return o
                    };
                ...
                if ((f.itemPull[this.id]["complex"]) && (f.conf.selected != -1)) {
                    if (f.conf.top_mode && f.conf.mode == "web" && !f.conf.context) {
                        ...
                        this._menuOpenTM = window.setTimeout(function () {
                            f._showPolygon(l, f.conf.dir_toplv)
                        }, f.conf.top_tmtime)
                    } else {
    ...
    a.onclick = function (m) {
        ...
        var i = (f.itemPull[this.id]["complex"] ? "c" : "-");
        ...
        f._doOnClick(this.id.replace(f.idPrefix, ""), i + n + "t", j);
        return false
    };
    if (this.conf.skin == "dhx_terrace") {
...
dhtmlXMenuObject.prototype._renderSublevelItem = function (a, j) {
    ...
    if (l != "") {
        ...
        if (!(o == "checkbox" || o == "radio")) {
            if (this.conf.icons_css == true) {
                g.innerHTML = "<i class='" + this.conf.icons_path + l + "'></i>"
            } else {
...
dhtmlXMenuObject.prototype._doOnContextBeforeCall = function (f, h) {
    ...
    if (window.dhx4.isChrome == true || window.dhx4.isEdge == true || window.dhx4.isOpera == true || window.dhx4.isIE11 == true) {
        var g = window.dhx4.absLeft(f.target) + f.offsetX;
        var d = window.dhx4.absTop(f.target) + f.offsetY
    } else {
...
function dhtmlXToolbarObject(b, c) {
    var a = this;
    this.conf = {
        skin: (c || window.dhx4.skin || (typeof (dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhxtoolbar") || "material"),
        align: "left",
    ...
    if (typeof (b) == "object" && b != null && typeof (b.tagName) == "undefined") {
        ...
        if (b.iconset != null) {
            this.conf.icons_css = (b.iconset == "awesome")
        }
        if (b.json != null) {
    ...
    this._addImgObj = function (e) {
        var d = document.createElement(this.conf.icons_css == true ? "I" : "IMG");
    ...
    this._setItemImage = function (g, e, d) {
        ...
        if (this.conf.icons_css == true) {
            var f = this._getObj(g.obj, "i");
            if (f == null) {
                f = this._addImgObj(g.obj)
            }
            f.className = this.conf.icons_path + e
        } else {
    ...
    this._clearItemImage = function (f, d) {
        ...
        var e = this._getObj(f.obj, (this.conf.icons_css ? "i" : "img"));
        if (e != null) {
            e.parentNode.removeChild(e)
        }
    };
    ...
    this._enableItem = function (e) {
        ...
        var d = this._getObj(e.obj, (this.conf.icons_css ? "i" : "img"));
        if (e.imgEn != "") {
            if (d == null) {
                d = this._addImgObj(e.obj)
            }
            d[this.conf.icons_css ? "className" : "src"] = this.conf.icons_path + e.imgEn
        } else {
            if (d != null) {
    ...
    this._disableItem = function (e) {
        ...
        if (e.imgDis != "") {
            ...
            d[this.conf.icons_css ? "className" : "src"] = this.conf.icons_path + e.imgDis
        } else {
            if (d != null) {
                d.parentNode.removeChild(d)
            }
...
dhtmlXToolbarObject.prototype._removeItem = function (e) {
    ...
    if ({
        ...
        this._evs.clear.apply(d, [d.obj.evs, d.obj]);
        for (var b in d.obj) {
            if (typeof (d.obj[b]) == "function") {
                d.obj[b] = null
            }
        }
    ...
    if (c == "buttonSelect") {
        ...
        this._evs.clear.apply(d, [d.obj.evs, d.obj]);
        this._evs.clear.apply(d, [d.arw.evs, d.arw]);
        for (var b in d.obj) {
            if (typeof (d.obj[b]) == "function") {
                d.obj[b] = null
            }
...
dhtmlXToolbarObject.prototype._buttonObject = function (c, e, d) {
    this.id = c.idPrefix + e;
    this.state = (d.enabled != null ? false : true);
    this.imgEn = (d.img || "");
    this.imgDis = (d.imgdis || "");
    ...
    this.obj.extAction = (d.action || null);
    this.obj.renderAs = this.obj.className;
    this.obj.idd = String(e);
    this.obj.title = (d.title || "");
    this.obj.pressed = false;
    var a = (c.conf.icons_css ? "<i class='" + c.conf.icons_path + this.img + "'></i>" : "<img src='" + c.conf.icons_path + this.img + "'>");
    this.obj.innerHTML = c._rtlParseBtn((this.img != "" ? a : ""), (d.text != null ? "<div class='dhxtoolbar_text'>" + d.text + "</div>" : ""));
    ...
    var b = this;
    this._doOnMouseOver = function (f) {
        f = f || event;
        if (b.state == false || b.obj.pressed == true || b.obj.over == true) {
            return
        }
        if (b.obj.className.match(/dhxtoolbar_btn_over/gi) == null) {
            b.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_over"
        }
        b.obj.over = true
    };
    this._doOnMouseOut = function (f) {
        f = f || event;
        if (b.state == false) {
            return
        }
        if (b.obj.className.match(/dhxtoolbar_btn_over/gi) != null) {
            b.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_def"
        }
        b.obj.over = b.obj.pressed = false
    };
    this._doOnMouseDown = function (f) {
        f = f || event;
        if (f.type == "touchstart") {
            ...
            f.cancelBubble = true;
            if (c.conf.touch_id != null && c.conf.touch_id != b.id) {
                return
            }
            c.conf.touch_id = b.id
        }
        if (b.state == false) {
            return
        }
        if (b.obj.className.match(/dhxtoolbar_btn_pres/gi) == null) {
            b.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_pres"
        }
        b.obj.pressed = true
    };
    this._doOnMouseUp = function (f) {
        f = f || event;
        if (f.type == "touchend") {
            if (f.preventDefault) {
                f.preventDefault()
            ...
            f.cancelBubble = true;
            if (c.conf.touch_id == b.id) {
                c.conf.touch_id = null
            }
        }
        if (b.state == false || b.obj.pressed == false) {
            return
        }
        if (b.obj.className.match(/dhxtoolbar_btn_pres/gi) != null) {
            b.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_" + (b.obj.over ? "over" : "def")
        }
        b.obj.pressed = false;
        if (b.obj.extAction) {
            window.setTimeout(function () {
                try {
                    if (b && b.obj) {
                        window[b.obj.extAction](b.id)
                    }
                } catch (g) { }
            }, 1)
        }
        c.callEvent("onClick", [b.obj.idd.replace(c.idPrefix, "")])
    };
    this.obj.evs = {
    ...
    c._evs.add.apply(this, [this.obj.evs, this.obj]);
    ...
    this.setItemText = function (f) {
        c._setItemText(this, f)
    };
    this.getItemText = function () {
        return c._getItemText(this)
    };
    this.setItemImage = function (f) {
        c._setItemImage(this, f, true)
    };
    this.clearItemImage = function () {
        c._clearItemImage(this, true)
    };
    this.setItemImageDis = function (f) {
        c._setItemImage(this, f, false)
    };
...
dhtmlXToolbarObject.prototype._buttonSelectObject = function (d, g, f) {
    this.id = d.idPrefix + g;
    this.state = (f.enabled != null ? (f.enabled == "true" ? true : false) : true);
    this.imgEn = (f.img || "");
    this.imgDis = (f.imgdis || "");
    this.img = (this.state ? (this.imgEn != "" ? this.imgEn : "") : (this.imgDis != "" ? this.imgDis : ""));
    this.mode = (f.mode || "button");
    if (this.mode == "select") {
        this.openAll = true;
        ...
        this.openAll = (window.dhx4.s2b(f.openAll) == true);
        this.renderSelect = (f.renderSelect == null ? true : window.dhx4.s2b(f.renderSelect))
    }
    this.maxOpen = (!isNaN(f.maxOpen ? f.maxOpen : "") ? f.maxOpen : null);
    this._maxOpenTest = function () {
        if (!isNaN(this.maxOpen)) {
            if (!d._sbw) {
                var i = document.createElement("DIV");
                i.className = "dhxtoolbar_maxopen_test";
                document.body.appendChild(i);
                var h = document.createElement("DIV");
                h.className = "dhxtoolbar_maxopen_test2";
                i.appendChild(h);
                d._sbw = i.offsetWidth - h.offsetWidth;
                i.removeChild(h);
                h = null;
    ...
    this.obj = document.createElement("DIV");
    this.obj.allowClick = false;
    this.obj.extAction = (f.action || null);
    this.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_" + (this.state ? "def" : "dis");
    this.obj.style.display = (f.hidden != null ? "none" : "");
    this.obj.renderAs = this.obj.className;
    ...
    this.obj.title = (f.title || "");
    this.obj.pressed = false;
    this.callEvent = false;
    var b = (d.conf.icons_css ? "<i class='" + d.conf.icons_path + this.img + "'></i>" : "<img src='" + d.conf.icons_path + this.img + "'>");
    this.obj.innerHTML = d._rtlParseBtn((this.img != "" ? b : ""), (f.text != null ? "<div class='dhxtoolbar_text'>" + f.text + "</div>" : ""));
    ...
    this.arw.onselectstart = function (h) {
        h = h || event;
        if (h.preventDefault) {
            h.preventDefault()
        } else {
    ...
    d.base.appendChild(this.arw);
    var a = this;
    if (window.dhx4.isIE) {
        this.arw.onselectstart = this.obj.onselectstart = function (h) {
            h = h || event;
            if (h.preventDefault) {
                h.preventDefault()
            } else {
    ...
    this._doOnMouseOver = function (h) {
        h = h || event;
        if (a.state == false || a.obj.over == true || d.anyUsed == a.obj.idd) {
            return
        }
    ...
    this._doOnMouseOut = function (h) {
        h = h || event;
        if (a.state == false || d.anyUsed == a.obj.idd || d.anyUsed == a.obj.idd) {
            return
        }
        if (a.obj.className.match(/dhxtoolbar_btn_over/gi) != null) {
    ...
    this._doOnMouseDown = function (i) {
        i = i || event;
        if (i.type == "touchstart") {
            ...
            i.cancelBubble = true;
            if (d.conf.touch_id != null && d.conf.touch_id != a.id) {
                return
            }
            d.conf.touch_id = a.id
        }
        if (a.state == false) {
            return
        }
        if (d.anyUsed == a.obj.idd) {
            if (a.obj.over == true) {
                a.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_over";
                a.arw.className = "dhx_toolbar_arw dhxtoolbar_btn_over"
            } else {
            ...
            if (a.openAll == true || h == a.arw || h.parentNode == a.arw) {
                if (i.type == "touchstart") {
                    a.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_over"
                }
    ...
    this._doOnMouseUp = function (i) {
        ...
        if (i.type == "touchend") {
            ...
            i.cancelBubble = true;
            if (d.conf.touch_id == a.id) {
                d.conf.touch_id = null
            }
        }
        ...
        d.callEvent("onClick", [a.obj.idd.replace(d.idPrefix, "")])
    };
    this.arw.evs = {
        mouseover: "_doOnMouseOver",
        mouseout: "_doOnMouseOut",
    ...
    d._evs.add.apply(this, [this.arw.evs, this.arw]);
    this.obj.evs = {
        mouseover: "_doOnMouseOver",
        mouseout: "_doOnMouseOut",
        mousedown: "_doOnMouseDown",
    ...
    d._evs.add.apply(this, [this.obj.evs, this.obj]);
    this._showPoly = function (p) {
        if (d.anyUsed != null) {
            if (d.objPull[d.idPrefix + d.anyUsed].type == "buttonSelect") {
                var o = d.objPull[d.idPrefix + d.anyUsed];
                if (o.polygon.style.display != "none") {
                    o.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_def";
                    o.arw.className = "dhx_toolbar_arw dhxtoolbar_btn_def";
                    o.obj.over = false;
                    ...
                    if (d.conf.skin == "dhx_terrace") {
                        d._improveTerraceButtonSelect(o.id, true)
                    }
                    d.callEvent("onButtonSelectHide", [o.obj.idd])
                }
            }
        }
        ...
        if (d.conf.skin == "dhx_terrace") {
            d._improveTerraceButtonSelect(this.id, false)
        }
        this._fixMaxOpenHeight(this.maxOpen || null);
        d._autoDetectVisibleArea();
        var j = window.dhx4.absTop(this.obj) + this.obj.offsetHeight + d.conf.sel_ofs_y;
        var m = this.polygon.offsetHeight;
        if (j + m > d.tY2) {
            var h = (this.maxOpen != null ? Math.floor((d.tY2 - j) / 22) : 0);
            if (h >= 1) {
                this._fixMaxOpenHeight(h)
            } else {
                j = window.dhx4.absTop(this.obj) - m - d.conf.sel_ofs_y;
                if (j < 0) {
                    j = 0
                }
            }
        }
        this.polygon.style.top = j + "px";
        if (d.rtl) {
            this.polygon.style.left = window.dhx4.absLeft(this.obj) + this.obj.offsetWidth - this.polygon.offsetWidth + d.conf.sel_ofs_x + "px"
        } else {
            var l = document.body.scrollLeft;
            var i = l + (window.innerWidth || document.body.clientWidth);
            var n = window.dhx4.absLeft(this.obj) + d.conf.sel_ofs_x;
            if (n + this.polygon.offsetWidth > i) {
                n = window.dhx4.absLeft(this.arw) + this.arw.offsetWidth - this.polygon.offsetWidth
            }
            this.polygon.style.left = Math.max(n, 5) + "px"
        }
        ...
        if (p) {
            d.callEvent("onButtonSelectShow", [this.obj.idd])
        }
    };
    this._hidePoly = function (h) {
        ...
        if (d.conf.skin == "dhx_terrace") {
            d._improveTerraceButtonSelect(this.id, true)
        }
        if (h) {
            d.callEvent("onButtonSelectHide", [this.obj.idd])
        }
        d.conf.touch_id = null
    };
    this.obj.iddPrefix = d.idPrefix;
    this._listOptions = {};
    this._fixMaxOpenHeight = function (n) {
        var m = "auto";
        var l = false;
        if (n !== null) {
            var j = 0;
            for (var i in this._listOptions) {
                j++
            }
            if (j > n) {
                this._ph = 22 * n;
        ...
        if (!l && a.maxOpen != null) {
            this.polygon.style.width = this.p_tbl.offsetWidth + d._sbw + "px";
            this.polygon.style.height = m
        }
    };
    this._separatorButtonSelectObject = function (j, h, i) {
        this.obj = {};
        this.obj.tr = document.createElement("TR");
        this.obj.tr.className = "tr_sep";
        this.obj.tr.onselectstart = function (l) {
            l = l || event;
            if (l.preventDefault) {
                l.preventDefault()
            } else {
        ...
        this.obj.td.onselectstart = function (l) {
            l = l || event;
            if (l.preventDefault) {
                l.preventDefault()
            } else {
        ...
        if (isNaN(i)) {
            i = a.p_tbody.childNodes.length + 1
        } else {
            if (i < 1) {
                i = 1
            }
        }
        if (i > a.p_tbody.childNodes.length) {
            a.p_tbody.appendChild(this.obj.tr)
        } else {
            a.p_tbody.insertBefore(this.obj.tr, a.p_tbody.childNodes[i - 1])
        }
        this.obj.tr.appendChild(this.obj.td);
        this.obj.sep = document.createElement("DIV");
        this.obj.sep.className = "btn_sep";
        this.obj.sep.onselectstart = function (l) {
            l = l || event;
            if (l.preventDefault) {
                l.preventDefault()
            } else {
        ...
        a._listOptions[j] = this.obj;
        return this
    };
    this._buttonButtonSelectObject = function (m, j, l) {
        var i = true;
        if (typeof (j.enabled) != "undefined") {
            i = window.dhx4.s2b(j.enabled)
        } else {
            if (typeof (j.disabled) != "undefined") {
                i = window.dhx4.s2b(j.disabled)
            }
        }
        this.obj = {};
        this.obj.tr = document.createElement("TR");
        this.obj.tr.en = i;
        this.obj.tr.extAction = (j.action || null);
        this.obj.tr._selected = (j.selected != null);
        this.obj.tr.className = "tr_btn" + (this.obj.tr.en ? (this.obj.tr._selected && a.renderSelect ? " tr_btn_selected" : "") : " tr_btn_disabled");
        this.obj.tr.onselectstart = function (n) {
            n = n || event;
            if (n.preventDefault) {
                n.preventDefault()
            } else {
        ...
        this.obj.tr.idd = String(m);
        if (isNaN(l)) {
            l = a.p_tbody.childNodes.length + 1
        } else {
            if (l < 1) {
                l = 1
            }
        }
        if (l > a.p_tbody.childNodes.length) {
            a.p_tbody.appendChild(this.obj.tr)
        } else {
            a.p_tbody.insertBefore(this.obj.tr, a.p_tbody.childNodes[l - 1])
        }
        this.obj.td_a = document.createElement("TD");
        this.obj.td_a.className = "td_btn_img";
        this.obj.td_a.onselectstart = function (n) {
            n = n || event;
            if (n.preventDefault) {
                n.preventDefault()
            } else {
        ...
        this.obj.td_b.onselectstart = function (n) {
            n = n || event;
            if (n.preventDefault) {
                n.preventDefault()
            } else {
        ...
        if (j.img != null) {
            if (d.conf.icons_css == true) {
                this.obj.td_a.innerHTML = "<i class='" + d.conf.icons_path + j.img + "'></i>"
            } else {
                this.obj.td_a.innerHTML = "<img class='btn_sel_img' src='" + d.conf.icons_path + j.img + "' border='0'>"
            }
            this.obj.tr._img = j.img
        } else {
            this.obj.td_a.innerHTML = "&nbsp;"
        }
        var h = (j.text != null ? j.text : (j.itemText || ""));
        this.obj.td_b.innerHTML = "<div class='btn_sel_text'>" + h + "</div>";
        this.obj.tr.onmouseover = function (n) {
            n = n || event;
            if (n.type.match(/touch/) != null) {
                return
            }
        ...
        this.obj.tr.onmouseout = function (n) {
            n = n || event;
            if (n.type.match(/touch/) != null) {
                return
            }
        ...
        this.obj.tr.ontouchstart = this.obj.tr.onmousedown = function (n) {
            n = n || event;
            if (this._etype == null) {
                this._etype = n.type
            }
        };
        this.obj.tr.onclick = function (o) {
            o = o || event;
            o.cancelBubble = true;
            if (!this.en) {
                return
            }
            a.setListOptionSelected(this.idd.replace(d.idPrefix, ""));
            a.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_def";
            a.arw.className = "dhx_toolbar_arw dhxtoolbar_btn_def";
            a.obj.over = false;
            ...
            this._etype = null;
            if (d.conf.skin == "dhx_terrace") {
                d._improveTerraceButtonSelect(a.id, true)
            }
            d.anyUsed = null;
            d.conf.touch_id = null;
            d.callEvent("onButtonSelectHide", [a.obj.idd]);
            var q = this.idd.replace(d.idPrefix, "");
            if (this.extAction) {
                try {
                    window[this.extAction](q)
                } catch (o) { }
            }
            d.callEvent("onClick", [q])
        };
        a._listOptions[m] = this.obj;
        return this
    };
    this.polygon = document.createElement("DIV");
    this.polygon.dir = "ltr";
    this.polygon.style.display = "none";
    this.polygon.className = "dhx_toolbar_poly_" + d.conf.skin + " dhxtoolbar_icons_" + d.conf.iconSize + d.conf.cssShadow;
    this.polygon.onselectstart = function (h) {
        h = h || event;
        if (h.preventDefault) {
            h.preventDefault()
        } else {
    ...
    this.polygon.onmousedown = function (h) {
        h = h || event;
        h.cancelBubble = true
    };
    this.polygon.style.overflowY = "auto";
    this.polygon._idd = window.dhx4.newId();
    this.polygon.ontouchstart = function (h) {
        h = h || event;
        h.cancelBubble = true
    };
    this.polygon.ontouchend = function (h) {
        h = h || event;
        h.cancelBubble = true
    };
    ...
    if (f.options != null) {
        for (var e = 0; e < f.options.length; e++) {
            var c = "_" + (f.options[e].type || "") + "ButtonSelectObject";
            if (f.options[e].id == null) {
                f.options[e].id = d._genStr(24)
            }
            if (typeof (this[c]) == "function") {
                new this[c](f.options[e].id, f.options[e])
            }
        }
    }
    ...
    this.setWidth = function (h) {
        this.obj.style.width = h - this.arw.offsetWidth + "px";
    ...
    this.setItemText = function (h) {
        d._setItemText(this, h)
    };
    this.getItemText = function () {
        return d._getItemText(this)
    };
    this.setItemImage = function (h) {
        d._setItemImage(this, h, true)
    };
    this.clearItemImage = function () {
        d._clearItemImage(this, true)
    };
    this.setItemImageDis = function (h) {
        d._setItemImage(this, h, false)
    };
    this.clearItemImageDis = function () {
        d._clearItemImage(this, false)
    };
    ...
    this.addListOption = function (n, m, j, l, h) {
        if (!(j == "button" || j == "separator")) {
            return
        }
        var i = {
            id: n,
        ...
        new this["_" + j + "ButtonSelectObject"](n, i, m)
    };
    this.removeListOption = function (j) {
        if (!this._isListButton(j, true)) {
            return
        }
        var h = this._listOptions[j];
        if (h.td_a != null && h.td_b != null) {
            h.td_a.onselectstart = null;
            h.td_b.onselectstart = null;
            while (h.td_a.childNodes.length > 0) {
                h.td_a.removeChild(h.td_a.childNodes[0])
            }
            while (h.td_b.childNodes.length > 0) {
                h.td_b.removeChild(h.td_b.childNodes[0])
            }
            h.tr.onselectstart = null;
            h.tr.onmouseover = null;
            h.tr.onmouseout = null;
            h.tr.onclick = null;
            h.tr.ontouchstart = null;
            h.tr.onmousedown = null;
            while (h.tr.childNodes.length > 0) {
                h.tr.removeChild(h.tr.childNodes[0])
            }
            h.tr.parentNode.removeChild(h.tr);
            h.td_a = null;
            h.td_b = null;
            h.tr = null
        } else {
            h.sep.onselectstart = null;
            h.td.onselectstart = null;
            h.tr.onselectstart = null;
            while (h.td.childNodes.length > 0) {
                h.td.removeChild(h.td.childNodes[0])
            }
            while (h.tr.childNodes.length > 0) {
                h.tr.removeChild(h.tr.childNodes[0])
            }
        ...
        h = null;
        this._listOptions[j] = null;
        try {
            delete this._listOptions[j]
        } catch (i) { }
    };
    this.showListOption = function (h) {
        if (!this._isListButton(h, true)) {
            return
        }
        this._listOptions[h].tr.style.display = ""
    };
    this.hideListOption = function (h) {
        if (!this._isListButton(h, true)) {
            return
        }
        this._listOptions[h].tr.style.display = "none"
    };
    this.isListOptionVisible = function (h) {
        if (!this._isListButton(h, true)) {
            return
        }
        return (this._listOptions[h].tr.style.display != "none")
    };
    this.enableListOption = function (h) {
        if (!this._isListButton(h)) {
            return
        }
        this._listOptions[h].tr.en = true;
        this._listOptions[h].tr.className = "tr_btn" + (this._listOptions[h].tr._selected && d.renderSelect ? " tr_btn_selected" : "")
    };
    this.disableListOption = function (h) {
        if (!this._isListButton(h)) {
            return
        }
        this._listOptions[h].tr.en = false;
        this._listOptions[h].tr.className = "tr_btn tr_btn_disabled"
    };
    this.isListOptionEnabled = function (h) {
        if (!this._isListButton(h)) {
            return
        }
        return this._listOptions[h].tr.en
    };
    this.setListOptionPosition = function (j, i) {
        if (!this._listOptions[j] || this.getListOptionPosition(j) == i || isNaN(i)) {
            return
        }
        if (i < 1) {
            i = 1
        }
        var h = this._listOptions[j].tr;
        this.p_tbody.removeChild(h);
        if (i > this.p_tbody.childNodes.length) {
            this.p_tbody.appendChild(h)
        } else {
            this.p_tbody.insertBefore(h, this.p_tbody.childNodes[i - 1])
        }
        h = null
    };
    this.getListOptionPosition = function (j) {
        var i = -1;
        if (!this._listOptions[j]) {
            return i
        }
        for (var h = 0; h < this.p_tbody.childNodes.length; h++) {
            if (this.p_tbody.childNodes[h] == this._listOptions[j].tr) {
                i = h + 1
            }
        }
        return i
    };
    this.setListOptionImage = function (j, h) {
        if (!this._isListButton(j)) {
            return
        }
        var i = this._listOptions[j].tr.childNodes[(d.rtl ? 1 : 0)];
        i.innerHTML = (d.conf.icons_css ? "<i class='" + d.conf.icons_path + h + "'></i>" : "<img src='" + d.conf.icons_path + h + "' class='btn_sel_img'>");
        i = null
    };
    this.getListOptionImage = function (j) {
        if (!this._isListButton(j)) {
            return
        }
        var i = this._listOptions[j].tr.childNodes[(d.rtl ? 1 : 0)];
        ...
        if (i.childNodes.length > 0) {
            h = i.childNodes[0][(d.conf.icons_css ? "className" : "src")]
        }
        i = null;
        return h
    };
    this.clearListOptionImage = function (i) {
        if (!this._isListButton(i)) {
            return
        }
        var h = this._listOptions[i].tr.childNodes[(d.rtl ? 1 : 0)];
    ...
    this.setListOptionText = function (i, h) {
        if (!this._isListButton(i)) {
            return
        }
        this._listOptions[i].tr.childNodes[(d.rtl ? 0 : 1)].childNodes[0].innerHTML = h
    };
    this.getListOptionText = function (h) {
        if (!this._isListButton(h)) {
            return
        }
        return this._listOptions[h].tr.childNodes[(d.rtl ? 0 : 1)].childNodes[0].innerHTML
    };
    this.setListOptionToolTip = function (i, h) {
        if (!this._isListButton(i)) {
            return
        }
        this._listOptions[i].tr.title = h
    };
    this.getListOptionToolTip = function (h) {
        if (!this._isListButton(h)) {
            return
        }
        return this._listOptions[h].tr.title
    };
    this.forEachListOption = function (i) {
        for (var h in this._listOptions) {
            i(h)
        }
    };
    ...
    this.setListOptionSelected = function (j) {
        for (var h in this._listOptions) {
            var i = this._listOptions[h];
            if (i.td_a != null && i.td_b != null && i.tr.en) {
                if (h == j) {
                    i.tr._selected = true;
                    i.tr.className = "tr_btn" + (this.renderSelect ? " tr_btn_selected" : "");
                    if (this.mode == "select") {
                        if (i.tr._img) {
                            this.setItemImage(i.tr._img)
                        } else {
                            this.clearItemImage()
                        }
                        this.setItemText(this.getListOptionText(j))
                    }
                } else {
                    i.tr._selected = false;
                    i.tr.className = "tr_btn"
                }
            }
            i = null
        }
    ...
    this.getListOptionSelected = function () {
        var i = null;
        for (var h in this._listOptions) {
            if (this._listOptions[h].tr._selected == true) {
                i = h
            }
        }
        return i
    };
    this._isListButton = function (i, h) {
        if (this._listOptions[i] == null) {
            return false
        }
        if (!h && this._listOptions[i].tr.className == "tr_sep") {
            return false
        }
        return true
    };
    this.setMaxOpen = function (h) {
        this._ph = null;
        if (typeof (h) == "number") {
            this.maxOpen = h;
            this._maxOpenTest();
    ...
    if (this.mode == "select" && typeof (f.selected) != "undefined") {
        this.setListOptionSelected(f.selected)
    }
    return this
};
...
dhtmlXToolbarObject.prototype._buttonTwoStateObject = function (c, e, d) {
    this.id = c.idPrefix + e;
    this.state = (d.enabled != null ? false : true);
    this.imgEn = (d.img != null ? d.img : "");
    this.imgDis = (d.imgdis != null ? d.imgdis : "");
    this.img = (this.state ? (this.imgEn != "" ? this.imgEn : "") : (this.imgDis != "" ? this.imgDis : ""));
    this.obj = document.createElement("DIV");
    this.obj.pressed = (d.selected != null);
    this.obj.extAction = (d.action || null);
    ...
    this._doOnMouseOver = function (f) {
        f = f || event;
        if (b.state == false || b.obj.over == true) {
            return
        }
        if (b.obj.pressed != true && b.obj.className.match(/dhxtoolbar_btn_over/gi) == null) {
            b.obj.className = "dhx_toolbar_btn dhxtoolbar_btn_over"
        }
        b.obj.over = true
    };
    ...
    this._doOnMouseDown = function (f) {
        ...
        if (c.callEvent("onBeforeStateChange", [b.obj.idd.replace(c.idPrefix, ""), b.obj.pressed]) !== true) {
            return
        }
        b.obj.pressed = !b.obj.pressed;
        b.obj.className = "dhx_toolbar_btn " + (b.obj.pressed == true ? "dhxtoolbar_btn_pres" : (b.obj.over == true ? "dhxtoolbar_btn_over" : "dhxtoolbar_btn_def"));
        var g = b.obj.idd.replace(c.idPrefix, "");
        if (b.obj.extAction) {
            try {
                window[b.obj.extAction](idd, b.obj.pressed)
            } catch (f) { }
        }
        c.callEvent("onStateChange", [g, b.obj.pressed])
    };
    this._doOnMouseUp = function (f) {
        f = f || event;
        if (f.type == "touchend") {
    ...
    this.setItemState = function (f, h) {
        if (this.obj.pressed != f) {
            ...
            if (h == true) {
                var i = this.obj.idd.replace(c.idPrefix, "");
                if (this.obj.extAction) {
                    try {
                        window[this.obj.extAction](i, this.obj.pressed)
                    } catch (g) { }
                }
                c.callEvent("onStateChange", [i, this.obj.pressed])
            }
        }
    };
...
dhtmlXToolbarObject.prototype._evs = {
    add: function (c, d) {
        for (var b in c) {
            if (typeof (window.addEventListener) == "function") {
                d.addEventListener(b, this[c[b]], false)
            } else {
                if (b.match(/^touch/) == null) {
                    d.attachEvent("on" + b, this[c[b]])
                }
            }
        }
        d = c = null
    ...
    clear: function (c, d) {
        for (var b in c) {
            if (typeof (window.addEventListener) == "function") {
                d.removeEventListener(b, this[c[b]], false)
            } else {
                if (b.match(/^touch/) == null) {
                    d.detachEvent("on" + b, this[c[b]])
                }
            }
        }
        d = c = null
...
dhtmlXToolbarObject.prototype.setSkin = function (e, c) {
    ...
    for (var b in this.objPull) {
        ...
        if (d.type == "buttonSelect") {
            d.polygon.className = "dhx_toolbar_poly_" + this.conf.skin + " dhxtoolbar_icons_" + this.conf.iconSize + this.conf.cssShadow
        }
    }
    if (e == "dhx_terrace") {
        this._improveTerraceSkin()
...
function dhtmlXGridObject(id) {
    ...
    window.dhtmlxEvent(window, "unload", function () {
        try {
            if (self.destructor) {
                self.destructor()
            }
...
dhtmlXGridObject.prototype = {
    ...
    adjustColumnSize: function (h, c) {
        if (this._hrrar && this._hrrar[h]) {
            return
        }
        this._notresize = true;
        var d = 0;
        this._setColumnSizeR(h, 20);
        for (var f = 1; f < this.hdr.rows.length; f++) {
            var o = this.hdr.rows[f];
            o = o.childNodes[(o._childIndexes) ? o._childIndexes[h] : h];
            if ((o) && ((!o.colSpan) || (o.colSpan < 2)) && o._cellIndex == h) {
                if ((o.childNodes[0]) && (o.childNodes[0].className == "hdrcell")) {
                    o = o.childNodes[0]
                }
                d = Math.max(d, o.scrollWidth)
            }
        }
        var e = this.obj.rows.length;
        var n = 0;
        var q = this.cellType._dhx_find("tree");
        for (var g = 1; g < e; g++) {
            var p = this.obj.rows[g];
            var b = h;
            if (!this.rowsAr[p.idd]) {
                continue
            }
            if (p._childIndexes) {
                if (p._childIndexes[h] == p._childIndexes[h + 1]) {
                    continue
                }
                b = p._childIndexes[h]
            }
            if (!p.childNodes[b] || p.childNodes[b]._cellIndex != h) {
                continue
            }
            n = (p.childNodes[b].innerText || p.childNodes[b].textContent || "").length * this.fontWidth;
            if (this._h2 && h == q) {
                n += this._h2.get[p.idd].level * 22
            }
            if (n > d) {
                d = n
            }
    ...
    load: function (a, c, b) {
        ...
        this.xmlLoader = function (e) {
            ...
            if (!d._contextCallTimer) {
                d.callEvent("onXLE", [d, 0, 0, e.xmlDoc, b])
            }
            if (c) {
                c();
                c = null
    ...
    render_dataset: function (d, j) {
        if (this._srnd) {
            if (this._fillers) {
                return this._update_srnd_view()
            }
            j = Math.min((this._get_view_size() + (this._srnd_pr || 0)), this.rowsBuffer.length)
        }
        if (this.pagingOn) {
            d = Math.max((d || 0), (this.currentPage - 1) * this.rowsBufferOutSize);
            j = Math.min(this.currentPage * this.rowsBufferOutSize, this.rowsBuffer.length)
        } else {
            d = d || 0;
            j = j || this.rowsBuffer.length
        }
        for (var e = d; e < j; e++) {
            var a = this.render_row(e);
            if (a == -1) {
                if (this.xmlFileUrl) {
                    if (this.callEvent("onDynXLS", [e, (this._dpref ? this._dpref : (j - e))])) {
                        this.load(this.xmlFileUrl + dhtmlx.url(this.xmlFileUrl) + "posStart=" + e + "&count=" + (this._dpref ? this._dpref : (j - e)), this._data_type)
                    }
                }
                j = e;
                break
        ...
        if (this._srnd && !this._fillers) {
            ...
            while (b > 0) {
                var f = (_isIE || window._FFrv) ? Math.min(b, c) : b;
                var g = this._add_filler(j, f);
                if (g) {
...
dhtmlXGridObject.prototype._dp_init = function (a) {
    ...
    this.attachEvent("onBindUpdate", function (c, b, d) {
        a.setUpdated(d, true)
    });
...
eXcell_ra.prototype.setValue = function (b) {
    ...
    if (b) {
        ...
        if (this.grid._RaSeCol[this.cell._cellIndex]) {
            var a = this.grid.cells(this.grid._RaSeCol[this.cell._cellIndex], this.cell._cellIndex);
            a.setValue("0");
...
function eXcell_icon(a) {
    ...
    this.setValue = function (c) {
        ...
        this.setCValue('<div class="dhx_grid_icon"><i class="fa fa-' + c.toString()._dhx_trim() + '"></i></div>')
    };
    this.getValue = function () {
...
eXcell_dyn.prototype.setValue = function (c) {
    ...
    this.setCValue("<div class='grid_cell_dyn'><img src='" + this.grid.imgURL + "" + a + "'><span style='color:" + b + ";'>" + c + "</span></div>", c)
};
...
function dragContext(v, u, t, s, r, q, o, p, n, i, g) {
    this.source = v || "grid";
    this.target = u || "grid";
    this.mode = t || "move";
...
dhtmlXGridObject.prototype._dragRoutine = function (m) {
    ...
    if (this._h2 && typeof m.tid != "undefined" && m.dropmode == "sibling" && (this._sbmod || m.tid)) {
        if (m.before) {
            g = m.uid().tobj.addRowBefore(m.nid, m.data(), m.tid, m.img(), m.childs())
        } else {
...
dhtmlXGridObject.prototype.selectBlock = function (d, c, b, a) {
    c = this.getRowIndex(c);
    a = this.getRowIndex(a);
    myGrid._CreateSelection(c, d);
    myGrid._selectionArea = myGrid._RedrawSelectionPos(myGrid.cells2(c, d).cell, myGrid.cells2(a, b).cell);
